    ...
    class CommunicationManager
    {
        ...
        public void WriteData(string msg)
        {
            switch (CurrentTransmissionType)
            {
                case TransmissionType.Text:
                    ...
                    {
                        DisplayData(MessageType.Outgoing, comPort.PortName + " is not open" + "\n");
                    }
                    else
                    {
        ...
        public bool ClosePort()
        {
            try
            {
                ...
                {
                    DisplayData(MessageType.Normal, comPort.PortName + " closed at " + DateTime.Now + "\n");
                }
                else
                {
                    DisplayData(MessageType.Normal, "Failed to close " + comPort.PortName + "\n");
                }
